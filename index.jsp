...
<!-- //for-mobile-apps -->
<link href="/TeacherInformationSystem/resources/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<link href="/TeacherInformationSystem/resources/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!-- js -->

<script type="text/javascript" src="/TeacherInformationSystem/resources/js/jquery-2.1.4.min.js"></script>
<!-- //js -->
<!-- pop-up-box -->
<link href="/TeacherInformationSystem/resources/css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
<!-- //pop-up-box -->
<!-- font-awesome icons -->
<link href="/TeacherInformationSystem/resources/css/font-awesome.css" rel="stylesheet"> 
<!-- //font-awesome icons -->
																	...
																	<h3 class="agileinfo_sign">Sign In</h3>	
																			<div class="login-form">
																				<form action="Authentication" method="post">
																					<input type="text" name="logInDTO.email" placeholder="E-mail" required="">
																					<input type="password" name="logInDTO.passWord" placeholder="Password" required="">
																					<select class="form-control" name="logInDTO.role" style="width:100%;">
																	...
																	<h3 class="agileinfo_sign">Sign Up</h3>	
																			<div class="login-form">
																				<form action="SignUp" method="post">
																				   <input type="text" name="logInDTO.userName" placeholder="Username" required="">
																					<input type="email" name="logInDTO.email" placeholder="Email" required="">
																					<input type="password" name="logInDTO.passWord" placeholder="Password" id="password" required="">
			...
			<div class="modal-content">
				...
				<section>
					<div class="modal-body">
						...
						<img src="/TeacherInformationSystem/resources/images/ab.jpg" alt=" " class="img-responsive" />
			...
			<div class="w3layouts-grids">
					...
					<div class="wthree_team_grid1">
						<div class="hover14 column">
							<div>
								<figure><img src="/TeacherInformationSystem/resources/images/2.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
				...
				<div class="col-md-3 wthree_team_grid">
					<div class="wthree_team_grid1">
						<div class="hover14 column">
							<div>
								<figure><img src="/TeacherInformationSystem/resources/images/4.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
						<div class="wthree_team_grid1_pos">
							<h4>Rosy Carl </h4>
				...
				<div class="col-md-3 wthree_team_grid">
					<div class="wthree_team_grid1">
						<div class="hover14 column">
							<div>
								<figure><img src="/TeacherInformationSystem/resources/images/1.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
						<div class="wthree_team_grid1_pos">
							<h4>David Martin</h4>
				...
				<div class="col-md-3 wthree_team_grid">
					<div class="wthree_team_grid1">
						<div class="hover14 column">
							<div>
								<figure><img src="/TeacherInformationSystem/resources/images/3.jpg" alt=" " class="img-responsive" /></figure>
							</div>
						</div>
						<div class="wthree_team_grid1_pos">
							<h4>Reena Scot</h4>
...
<div class="col-md-6 news-agileits-right news2">
		...
		<img src="/TeacherInformationSystem/resources/images/f3.jpg" alt="image"><h6>John Stella</h6>
	</div>
	...
	<div class="col-md-6 news-agileits-right">
		...
		<p>Cras id odio elit. Ut scelerisque pellentesque tortor, vitae sagittis metus maximus eu. Nulla vel luctus nunc, quis pulvinar mi.</p>
		<img src="/TeacherInformationSystem/resources/images/f4.jpg" alt="image"><h6>Anjelina</h6>
	</div>
	<div class="clearfix"></div>
	</div>
</div>
			...
			<div class="gallery-grids-row">
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="/TeacherInformationSystem/resources/images/g1.jpg" class="jzBoxLink item-hover" title="Education">  
							<img src="/TeacherInformationSystem/resources/images/g1.jpg" alt=" " class="img-responsive" />
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="/TeacherInformationSystem/resources/images/g2.jpg" class="jzBoxLink item-hover" title="Education">  
							<img src="/TeacherInformationSystem/resources/images/g2.jpg" alt=" " class="img-responsive" />
							<div class="view-caption">
								<p>Full View</p>
							</div> 
						</a>    			
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="/TeacherInformationSystem/resources/images/g3.jpg" class="jzBoxLink item-hover" title="Education">  
							<img src="/TeacherInformationSystem/resources/images/g3.jpg" alt=" " class="img-responsive" />
							<div class="view-caption">
								<p>Full View</p>
							</div> 
						</a>    			
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="/TeacherInformationSystem/resources/images/g4.jpg" class="jzBoxLink item-hover" title="Education">  
							<img src="/TeacherInformationSystem/resources/images/g4.jpg" alt=" " class="img-responsive" />
							<div class="view-caption">
								<p>Full View</p>
							</div> 
						</a>    			
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="/TeacherInformationSystem/resources/images/g5.jpg" class="jzBoxLink item-hover" title="Education">  
							<img src="/TeacherInformationSystem/resources/images/g5.jpg" alt=" " class="img-responsive" />
							<div class="view-caption">
								<p>Full View</p>
							</div> 
						</a>    		
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="/TeacherInformationSystem/resources/images/g6.jpg" class="jzBoxLink item-hover" title="Education">  
							<img src="/TeacherInformationSystem/resources/images/g6.jpg" alt=" " class="img-responsive" />
							<div class="view-caption">
								<p>Full View</p>
							</div> 
						</a>    		
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="/TeacherInformationSystem/resources/images/g7.jpg" class="jzBoxLink item-hover" title="Education">  
							<img src="/TeacherInformationSystem/resources/images/g7.jpg" alt=" " class="img-responsive" />
							<div class="view-caption">
								<p>Full View</p>
							</div> 
						</a>    			
				...
				<div class="col-md-3 gallery-grid">
					<div class="wpf-demo-4">  
						<a href="/TeacherInformationSystem/resources/images/g8.jpg" class="jzBoxLink item-hover" title="Education">  
							<img src="/TeacherInformationSystem/resources/images/g8.jpg" alt=" " class="img-responsive" />
							<div class="view-caption">
								<p>Full View</p>
							</div> 
						</a>    		
...
<script type="text/javascript" src="/TeacherInformationSystem/resources/js/jquery-2.1.4.min.js"></script>
<!--pop-up-box -->
					<script src="/TeacherInformationSystem/resources/js/jquery.magnific-popup.js" type="text/javascript"></script>
					<script>
...
<!-- //js -->
<script type="text/javascript" src="/TeacherInformationSystem/resources/js/move-top.js"></script>
<script type="text/javascript" src="/TeacherInformationSystem/resources/js/easing.js"></script>
...
<!-- start-smoth-scrolling -->
			...
			<script src="/TeacherInformationSystem/resources/js/jzBox.js"></script>

			<!-- Countdown-Timer-JavaScript -->
			<script src="/TeacherInformationSystem/resources/js/simplyCountdown.js"></script>
			<script>
...
<!-- //smooth scrolling -->
<script type="text/javascript" src="/TeacherInformationSystem/resources/js/bootstrap.js"></script>
</body>
</html>