...
-->
    ...
    <link rel="stylesheet" href="/TeacherInformationSystem/resources/font-awesome-4.5.0/css/font-awesome.min.css">                
    <!-- Font Awesome -->
    <link rel="stylesheet" href="/TeacherInformationSystem/resources/css/bootstrap.min.css">                                      
    <!-- Bootstrap style -->
    <link rel="stylesheet" href="/TeacherInformationSystem/resources/css/hero-slider-style.css">                              
    <!-- Hero slider style (https://codyhouse.co/gem/hero-slider/) -->
    <link rel="stylesheet" href="/TeacherInformationSystem/resources/css/magnific-popup.css">                                 
    <!-- Magnific popup style (http://dimsemenov.com/plugins/magnific-popup/) -->
    <link rel="stylesheet" href="/TeacherInformationSystem/resources/css/templatemo-style.css">                                   
    <!-- Templatemo style -->
    ...
    <body>
            ...
            <div class="cd-slider-nav">
                <nav class="navbar">
                    <div class="tm-navbar-bg">
                        ...
                        <div class=" navbar-toggleable-md text-xs-center text-uppercase tm-navbar" id="tmNavbar">
                                ...
                                <!-- Gallery One pop up connected with JS code below -->                                    
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-ruby">
                                            <img src="/TeacherInformationSystem/resources/img/tm-img-01-tn.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-ruby">
                                            <img src="/TeacherInformationSystem/resources/img/tm-img-02-tn.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-ruby">
                                            <img src="/TeacherInformationSystem/resources/img/tm-img-03-tn.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-ruby">
                                            <img src="/TeacherInformationSystem/resources/img/tm-img-04-tn.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                        ...
                        <div class="container-fluid js-tm-page-content" data-page-no="3" data-page-type="gallery">
                            <div class="tm-img-gallery-container tm-img-gallery-container-2">
                                ...
                                <!-- Gallery Two pop up connected with JS code below -->
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-ruby">
                                            <img src="/TeacherInformationSystem/resources/img/tm-img-05-tn.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-ruby">
                                            <img src="/TeacherInformationSystem/resources/img/tm-img-06-tn.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-ruby">
                                            <img src="/TeacherInformationSystem/resources/img/tm-img-07-tn.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-ruby">
                                            <img src="/TeacherInformationSystem/resources/img/tm-img-08-tn.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-ruby">
                                            <img src="/TeacherInformationSystem/resources/img/tm-img-09-tn.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-ruby">
                                            <img src="/TeacherInformationSystem/resources/img/tm-img-10-tn.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                        ...
                        <div class="container-fluid js-tm-page-content" data-page-no="4" data-page-type="gallery">                        
                            <div class="tm-img-gallery-container tm-img-gallery-container-3">
                                ...
                                <!-- Gallery Two pop up connected with JS code below -->
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-ruby">
                                            <img src="/TeacherInformationSystem/resources/img/tm-img-11-tn.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                                <h2 class="tm-figure-title">Picture <span>One</span></h2>
                                                <p class="tm-figure-description">Suspendisse id placerat risus. Mauris quis luctus risus.</p>
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-ruby">
                                            <img src="/TeacherInformationSystem/resources/img/tm-img-12-tn.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                                <h2 class="tm-figure-title">Picture <span>Two</span></h2>
                                                <p class="tm-figure-description">Maecenas purus sem, lobortis id odio in sapien.</p>
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-ruby">
                                            <img src="/TeacherInformationSystem/resources/img/tm-img-13-tn.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                                <h2 class="tm-figure-title">Picture <span>Three</span></h2>
                                                <p class="tm-figure-description">Suspendisse id placerat risus. Mauris quis luctus risus.</p>
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-ruby">
                                            <img src="/TeacherInformationSystem/resources/img/tm-img-14-tn.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                                <h2 class="tm-figure-title">Picture <span>Four</span></h2>
                                                <p class="tm-figure-description">Maecenas purus sem, lobortis id odio in sapien.</p>
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-ruby">
                                            <img src="/TeacherInformationSystem/resources/img/tm-img-15-tn.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                                <h2 class="tm-figure-title">Picture <span>Five</span></h2>
                                                <p class="tm-figure-description">Suspendisse id placerat risus. Mauris quis luctus risus.</p>
                                    ...
                                    <div class="grid-item">
                                        <figure class="effect-ruby">
                                            <img src="/TeacherInformationSystem/resources/img/tm-img-16-tn.jpg" alt="Image" class="img-fluid tm-img">
                                            <figcaption>
                                                <h2 class="tm-figure-title">Picture <span>Six</span></h2>
                                                <p class="tm-figure-description">Maecenas purus sem, lobortis id odio in sapien.</p>
        ...
        <!-- load JS files -->
        <script src="/TeacherInformationSystem/resources/js/jquery-2.1.4.min.js"></script>         <!-- jQuery (https://jquery.com/download/) -->
        <script src="/TeacherInformationSystem/resources/js/tether.js"></script> <!-- Tether for Bootstrap (http://stackoverflow.com/questions/34567939/how-to-fix-the-error-error-bootstrap-tooltips-require-tether-http-github-h) --> 
        <script src="/TeacherInformationSystem/resources/js/bootstrap.min.js"></script>             <!-- Bootstrap js (v4-alpha.getbootstrap.com/) -->
        <script src="/TeacherInformationSystem/resources/js/hero-slider-main.js"></script>          <!-- Hero slider (https://codyhouse.co/gem/hero-slider/) -->
        <script src="/TeacherInformationSystem/resources/js/jquery.magnific-popup.min.js"></script> <!-- Magnific popup (http://dimsemenov.com/plugins/magnific-popup/) -->
